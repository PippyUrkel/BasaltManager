...
import '../widgets/flake_card.dart';
...
class _ServersScreenState extends State<ServersScreen>
  ...
  void _openSshTerminalForFlake(Server flake) {
    final host = (flake.host.toLowerCase() == 'localhost' || flake.host.isEmpty)
        ? '127.0.0.1'
        : flake.host;
                ...
                delegate: SliverChildBuilderDelegate(
                  (context, index) {
                    ...
                    return FlakeCard(
                      ...
                      onOpenTerminal: () =>
                          _openSshTerminalForFlake(flake),
                    );
                  },
